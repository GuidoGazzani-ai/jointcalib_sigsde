...
def OUL(d,m,Y_0,thetas,kappas,sigmas,Rho):   #Computes the matrix G^T associated to the drift operator
    '''                                      # See also implementation in Cuchiero, Svaluto-Ferro, Teichmann (2023)
    Inputs:
    d : int
    m : int 
...
def multidimensional_OU(X0,N,T,Rho,kappas,thetas,sigmas,flag_aug,flag_mat): 
    '''                                        # It generates a multi-dimensional OU but clearly can be replaced with exact simulation
    Inputs:                                   # since the distribution in known here. Same benefits as for Bergomi-type models.                   
